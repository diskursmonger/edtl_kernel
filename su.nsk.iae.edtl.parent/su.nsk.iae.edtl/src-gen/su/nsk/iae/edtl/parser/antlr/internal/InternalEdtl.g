...
entryRuleGlobInterval returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGlobIntervalRule()); }
	iv_ruleGlobInterval=ruleGlobInterval
	{ $current=$iv_ruleGlobInterval.current; }
	EOF;

// Rule GlobInterval
ruleGlobInterval returns [EObject current=null]
@init {
	enterRule();
}
@after {
